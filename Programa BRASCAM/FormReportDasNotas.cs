...
{
    public partial class FormReportDasNotas: Form
    {
        ...
        private void FormReportDasNotas_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportPath = Path.Combine(Application.StartupPath, "ReportDasNotas.rdlc");           
