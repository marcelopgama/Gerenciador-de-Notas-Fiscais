...
{
    public partial class FormCadastroVeiculos : Form
    {
        ...
        public FormCadastroVeiculos()
        {
            InitializeComponent(); 
            PreencherDataGrid();            
        }
        private void FormCadastroVeiculos_Load(object sender, EventArgs e)
        {
            if (adicionando == true)
            {                
        ...
        void PreencherDataGrid()
        {
            ...
            string command = "SELECT CodigoDoVeiculo,Descricao,Placa,Quilometragem FROM BRASCAMveiculos WHERE CodigoDoVeiculo IS NOT NULL";
            ...
            for (int n = 0; n < numeroDelinhas; n++)
            {
                ...
                dataGridView1.Rows[n].Cells[3].Value = dataTable.Rows[n][3].ToString();
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection connection = new SqlConnection(Programa_BRASCAM.Properties.Settings.Default.ConnectionString);
                string commandString = "DELETE FROM BRASCAMveiculos WHERE CodigoDoVeiculo=" + codigoSelecionado;
        ...
        {
            if (editando != true & adicionando != true & Programa_BRASCAM.Properties.Settings.Default.Permissão != 3)
            {
                textBox6.ReadOnly = false;
                textBox1.ReadOnly = false;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (editando == true | adicionando == true)
            {
                ...
                if (adicionando == true)
                {
                    commandString = "INSERT INTO BRASCAMveiculos (Descricao,Placa) VALUES"
                        + "('" + textBox6.Text + "','" + textBox1.Text + "')";
                }
                else if (editando == true)
                {
                    commandString = "UPDATE BRASCAMveiculos SET Descricao='" + textBox6.Text + "',Placa='" + textBox1.Text
                        + "' WHERE CodigoDoVeiculo='" + codigoSelecionado + "'";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (editando != true & adicionando != true & dataGridView1.SelectedRows.Count > 0 & Programa_BRASCAM.Properties.Settings.Default.Permissão != 3)
            {
                editando = true;
